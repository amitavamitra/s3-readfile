...
// instantiate s3 with the above aws config 
   var s3 = new aws.S3();
// console.log(s3);
///// 3.  read a file from a folder
/////Note- this file has to be there else you get an error.
  // var filePath = "saved_model.pb
  

  var filePath = 'TRAIN_DATA.txt';
  var params = {
    Bucket: "hcp-8da2bd2a-eb08-4998-baf0-3ceae565e40d",
    Key : "spacy" + "/" + path.basename(filePath),
      };

  // var filePath = "TRAIN_DATA.json";
  // var params = {
  //   Bucket: "hcp-8da2bd2a-eb08-4998-baf0-3ceae565e40d",
